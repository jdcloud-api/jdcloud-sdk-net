...
namespace JDCloudSDK.Rms.Client
{
    ...
    public class RmsClient : JdcloudClient
    {
        ...
        /// <param name="request">请求参数信息</param>
        /// <returns>请求结果信息</returns>
        public QueryOneTemplateResponse QueryOneTemplate(QueryOneTemplateRequest request) {
            return  new QueryOneTemplateExecutor().Client(this).Execute<QueryOneTemplateResponse, QueryOneTemplateResult, QueryOneTemplateRequest>(request);
        }
#else
        /// <summary>
        ///  查询一个富媒体短信内容接口
        ...
        /// <param name="request">请求参数信息</param>
        /// <returns>请求结果信息</returns>
        public async Task<QueryOneTemplateResponse> QueryOneTemplate(QueryOneTemplateRequest request) {
            return await new QueryOneTemplateExecutor().Client(this).Execute<QueryOneTemplateResponse, QueryOneTemplateResult, QueryOneTemplateRequest>(request).ConfigureAwait(false);
        }
#endif
#if NET40||NET35
        /// <summary>
