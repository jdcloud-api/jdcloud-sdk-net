...
namespace JDCloudSDK.Yunding.Client
{
    ...
    {
        /// <summary>
        ///  从RDS实例中删除数据库。为便于管理和数据恢复，RDS对用户权限进行了控制，用户仅能通过控制台或本接口删除数据库 [MFA enabled]接口的Http 请求方法
        /// </summary>
        ...
        /// <summary>
        ///  从RDS实例中删除数据库。为便于管理和数据恢复，RDS对用户权限进行了控制，用户仅能通过控制台或本接口删除数据库 [MFA enabled]接口的Http资源请求路径
        /// </summary>
