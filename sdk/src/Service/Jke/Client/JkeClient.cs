...
namespace JDCloudSDK.Jke.Client
{
    /// <summary>
    ///  jke
    ///  k8s 集群服务相关接口
    ///  Jke Api 客户端
    ///</summary>
    public class JkeClient : JdcloudClient
    {
        ...
        public JkeClient(CredentialsProvider credentialsProvider, HttpRequestConfig httpRequestConfig,SDKEnvironment environment)
        {
        ...
        /// <param name="httpRequestConfig">http 客户端配置信息</param>
        /// <param name="credentialsProvider">认证信息</param>
        public JkeClient(CredentialsProvider credentialsProvider,HttpRequestConfig httpRequestConfig)
        {
            this.httpRequestConfig = httpRequestConfig;
            this.credentialsProvider = credentialsProvider;
        }
        ...
        /// </summary>
        /// <param name="credentialsProvider">认证信息</param>
        public JkeClient(CredentialsProvider credentialsProvider)
        {
            this.credentialsProvider = credentialsProvider;
        }
            ...
            public class DefaultBuilder : Builder
            {
                ...
                public JkeClient Build()
                {
                    if (jkeClient.CredentialsProvider == null)
                    {
                        ...
                        if (jkeClient.credentialsProvider == null)
                        {
                            throw new ArgumentNullException("JkeClient build error: jdcloud credentials provider not set");
                        }
                    }
                    if (jkeClient.HttpRequestConfig == null)
                    {
                        ...
                        if (jkeClient.httpRequestConfig == null)
                        {
                        throw new ArgumentNullException("JkeClient build error: http request config not set");
                        }
                    }
                    return jkeClient;
                }
