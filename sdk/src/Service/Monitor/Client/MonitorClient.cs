...
namespace JDCloudSDK.Monitor.Client
{
    ...
    public class MonitorClient : JdcloudClient
    {
        ...
        /// <param name="request">请求参数信息</param>
        /// <returns>请求结果信息</returns>
        public DescribeMetricsForAlarmResponse DescribeMetricsForAlarm(DescribeMetricsForAlarmRequest request) {
            return  new DescribeMetricsForAlarmExecutor().Client(this).Execute<DescribeMetricsForAlarmResponse, DescribeMetricsForAlarmResult, DescribeMetricsForAlarmRequest>(request);
        }
#else
        /// <summary>
        ///  查询可用于创建监控规则的指标列表,metric介绍：&lt;a href&#x3D;&quot;https://docs.jdcloud.com/cn/monitoring/metrics&quot;&gt;Metrics&lt;/a&gt;
        ...
        /// <param name="request">请求参数信息</param>
        /// <returns>请求结果信息</returns>
        public async Task<DescribeMetricsForAlarmResponse> DescribeMetricsForAlarm(DescribeMetricsForAlarmRequest request) {
            return await new DescribeMetricsForAlarmExecutor().Client(this).Execute<DescribeMetricsForAlarmResponse, DescribeMetricsForAlarmResult, DescribeMetricsForAlarmRequest>(request).ConfigureAwait(false);
        }
#endif
#if NET40||NET35
        /// <summary>
        ...
        /// <param name="request">请求参数信息</param>
        /// <returns>请求结果信息</returns>
        public DescribeProductsForAlarmResponse DescribeProductsForAlarm(DescribeProductsForAlarmRequest request) {
            return  new DescribeProductsForAlarmExecutor().Client(this).Execute<DescribeProductsForAlarmResponse, DescribeProductsForAlarmResult, DescribeProductsForAlarmRequest>(request);
        }
#else
        /// <summary>
        ///  查询可用于创建监控规则的产品列表
        ...
        /// <param name="request">请求参数信息</param>
        /// <returns>请求结果信息</returns>
        public async Task<DescribeProductsForAlarmResponse> DescribeProductsForAlarm(DescribeProductsForAlarmRequest request) {
            return await new DescribeProductsForAlarmExecutor().Client(this).Execute<DescribeProductsForAlarmResponse, DescribeProductsForAlarmResult, DescribeProductsForAlarmRequest>(request).ConfigureAwait(false);
        }
#endif
#if NET40||NET35
        /// <summary>
        ...
        /// <param name="request">请求参数信息</param>
        /// <returns>请求结果信息</returns>
        public EnableAlarmsResponse EnableAlarms(EnableAlarmsRequest request) {
            return  new EnableAlarmsExecutor().Client(this).Execute<EnableAlarmsResponse, EnableAlarmsResult, EnableAlarmsRequest>(request);
        }
#else
        /// <summary>
        ///  启用、禁用规则
