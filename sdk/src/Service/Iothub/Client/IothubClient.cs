...
namespace JDCloudSDK.Iothub.Client
{
    ...
    public class IothubClient : JdcloudClient
    {
        ...
        /// <param name="request">请求参数信息</param>
        /// <returns>请求结果信息</returns>
        public RemoveDeviceByIdResponse RemoveDeviceById(RemoveDeviceByIdRequest request) {
            return  new RemoveDeviceByIdExecutor().Client(this).Execute<RemoveDeviceByIdResponse, RemoveDeviceByIdResult, RemoveDeviceByIdRequest>(request);
        }
#else
        /// <summary>
        ///  删除设备
        ...
        /// <param name="request">请求参数信息</param>
        /// <returns>请求结果信息</returns>
        public async Task<RemoveDeviceByIdResponse> RemoveDeviceById(RemoveDeviceByIdRequest request) {
            return await new RemoveDeviceByIdExecutor().Client(this).Execute<RemoveDeviceByIdResponse, RemoveDeviceByIdResult, RemoveDeviceByIdRequest>(request).ConfigureAwait(false);
        }
#endif
#if NET40||NET35
        /// <summary>
