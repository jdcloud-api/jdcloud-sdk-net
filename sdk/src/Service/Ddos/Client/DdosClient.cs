...
using JDCloudSDK.Ddos.Apis;
using JDCloudSDK.Ddos.Model;
using System;
...
namespace JDCloudSDK.Ddos.Client
{
    /// <summary>
    /// 京东云DDoS基础防护相关接口
    /// 京东云DDoS基础防护相关接口
    /// Ddos Api 客户端
    ///</summary>
    public class DdosClient : JdcloudClient
    {
        ...
        public DdosClient(CredentialsProvider credentialsProvider, HttpRequestConfig httpRequestConfig,SDKEnvironment environment)
        {
        ...
        /// <param name="httpRequestConfig">http 客户端配置信息</param>
        /// <param name="credentialsProvider">认证信息</param>
        public DdosClient(CredentialsProvider credentialsProvider,HttpRequestConfig httpRequestConfig)
        {
            this.httpRequestConfig = httpRequestConfig;
            this.credentialsProvider = credentialsProvider;
        }
        ...
        /// </summary>
        /// <param name="credentialsProvider">认证信息</param>
        public DdosClient(CredentialsProvider credentialsProvider)
        {
            this.credentialsProvider = credentialsProvider;
        }
        ...
        private const string defaultEndpoint = "ddos.jdcloud-api.com";
        private const string serviceName = "ddos";
        ...
        public async Task<DescribeIpResourceProtectInfoResponse> DescribeIpResourceProtectInfo(DescribeIpResourceProtectInfoRequest request) {
            ...
            public interface Builder
            {
                ...
                /// <returns>ddosClient 构造器</returns>
            ...
            {
                /// <summary>
                /// DdosClient service client
                /// </summary>
                private  DdosClient ddosClient;

                /// <summary>
                ///  默认DdosClient 构造器构造对象
                ///</summary>
                public DefaultBuilder()
                {
                    ddosClient = new DdosClient();
                }

                /// <summary>
                ///  构造DdosClient 对象
                ///</summary>
                public DdosClient Build()
                {
                    if (ddosClient.CredentialsProvider == null)
                    {
                        //if credentialsProvider not set, try load jdcloud global default  credentials provider
                        ddosClient.credentialsProvider = JdCloud.DefaultInstance.GetCredentialsProvider();
                        if (ddosClient.credentialsProvider == null)
                        {
                            throw new ArgumentNullException("DdosClient build error: jdcloud credentials provider not set");
                        }
                    }
                    if (ddosClient.HttpRequestConfig == null)
                    {
                        ddosClient.httpRequestConfig = JdCloud.DefaultInstance.GetHttpRequestConfig();
                        if (ddosClient.httpRequestConfig == null)
                        {
                        throw new ArgumentNullException("DdosClient build error: http request config not set");
                        }
                    }
                    return ddosClient;
                }
                ...
                {
                    ddosClient.credentialsProvider = provider;
                    return this;
                }
                ...
                {
                    ddosClient.environment = environment;
                    return this;
                }
                ...
                {
                    ddosClient.httpRequestConfig = config;
                    return this;
                }
            }
    }
