...
namespace JDCloudSDK.Rds.Client
{
    ...
    {
        /// <summary>
        ///  修改SQL Server数实例的配置参数。 部分参数修改后，需要重启才能生效，具体可以参考微软的相关文档&lt;br&gt;- 仅支持SQL Server接口的Http 请求方法
        /// </summary>
        ...
        /// <summary>
        ///  修改SQL Server数实例的配置参数。 部分参数修改后，需要重启才能生效，具体可以参考微软的相关文档&lt;br&gt;- 仅支持SQL Server接口的Http资源请求路径
        /// </summary>
