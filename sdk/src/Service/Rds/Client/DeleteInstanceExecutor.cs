...
namespace JDCloudSDK.Rds.Client
{
    ...
    {
        /// <summary>
        ///  删除数据库集群实例及Mysql只读实例&lt;/br&gt;- SQL Server：支持&lt;/br&gt;- MySQL：支持 敏感操作，可开启MFA操作保护接口的Http 请求方法
        /// </summary>
        ...
        /// <summary>
        ///  删除数据库集群实例及Mysql只读实例&lt;/br&gt;- SQL Server：支持&lt;/br&gt;- MySQL：支持 敏感操作，可开启MFA操作保护接口的Http资源请求路径
        /// </summary>
