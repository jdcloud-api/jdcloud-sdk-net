...
namespace JDCloudSDK.Rds.Client
{
    ...
    {
        /// <summary>
        ///  删除一个RDS实例或者MySQL的只读实例。删除MySQL主实例时，会同时将对应的MySQL只读实例也删除 [MFA enabled]接口的Http 请求方法
        /// </summary>
        ...
        /// <summary>
        ///  删除一个RDS实例或者MySQL的只读实例。删除MySQL主实例时，会同时将对应的MySQL只读实例也删除 [MFA enabled]接口的Http资源请求路径
        /// </summary>
