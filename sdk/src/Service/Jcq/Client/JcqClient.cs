...
namespace JDCloudSDK.Jcq.Client
{
    ...
    public class JcqClient : JdcloudClient
    {
        ...
        public SendMessageResponse SendMessage(SendMessageRequest request) {
            return  new SendMessageExecutor().Client(this).Execute<SendMessageResponse, SendMessageResult, SendMessageRequest>(request);
        }
#else
        /// <summary>
        /// 发送消息
        ...
        public async Task<SendMessageResponse> SendMessage(SendMessageRequest request) {
            return await new SendMessageExecutor().Client(this).Execute<SendMessageResponse, SendMessageResult, SendMessageRequest>(request);
        }
#endif
#if NET40||NET35
        /// <summary>
        ...
        public async Task<ModifySubscriptionAttributeResponse> ModifySubscriptionAttribute(ModifySubscriptionAttributeRequest request) {
            return await new ModifySubscriptionAttributeExecutor().Client(this).Execute<ModifySubscriptionAttributeResponse, ModifySubscriptionAttributeResult, ModifySubscriptionAttributeRequest>(request);
        }
#endif
#if NET40||NET35
        /// <summary>
        ...
        /// <param name="request">请求参数信息</param>
        /// <returns>请求结果信息</returns>
        public ModifyTopicAttributeResponse ModifyTopicAttribute(ModifyTopicAttributeRequest request) {
            return  new ModifyTopicAttributeExecutor().Client(this).Execute<ModifyTopicAttributeResponse, ModifyTopicAttributeResult, ModifyTopicAttributeRequest>(request);
        }
#else
        /// <summary>
        /// 修改topic，参数至少选一
        ...
        /// <param name="request">请求参数信息</param>
        /// <returns>请求结果信息</returns>
        public async Task<ModifyTopicAttributeResponse> ModifyTopicAttribute(ModifyTopicAttributeRequest request) {
            return await new ModifyTopicAttributeExecutor().Client(this).Execute<ModifyTopicAttributeResponse, ModifyTopicAttributeResult, ModifyTopicAttributeRequest>(request);
        }
#endif
#if NET40||NET35
        /// <summary>
