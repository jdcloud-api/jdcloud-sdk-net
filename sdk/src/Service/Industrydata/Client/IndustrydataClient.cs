...
using JDCloudSDK.Industrydata.Apis;
using JDCloudSDK.Industrydata.Model;
using System;
...
namespace JDCloudSDK.Industrydata.Client
{
    /// <summary>
    ///  产业数据服务API
    ///  产业数据服务API
    ///  Industrydata Api 客户端
    ///</summary>
    public class IndustrydataClient : JdcloudClient
    {
        ...
        /// </summary>
        /// <param name="credentialsProvider">认证信息</param>
        public IndustrydataClient(CredentialsProvider credentialsProvider)
        {
            this.credentialsProvider = credentialsProvider;
        }
        ...
        private const string defaultEndpoint = "industrydata.cn-south-1.jdcloud-api.com";
        private const string serviceName = "industrydata";
        ...
        public async Task<GetLargeScreenDataResponse> GetLargeScreenData(GetLargeScreenDataRequest request) {
            ...
            public interface Builder
            {
                ...
                /// <summary>
                ///  构造IndustrydataClient 对象
                ///</summary>
                IndustrydataClient Build();
            }

            /// <summary>
            ///  默认IndustrydataClient 构造器
            ///</summary>
            public class DefaultBuilder : Builder
            {
                /// <summary>
                ///  IndustrydataClient service client
                /// </summary>
                private  IndustrydataClient industrydataClient;

                /// <summary>
                ///  默认IndustrydataClient 构造器构造对象
                ///</summary>
                ...
                ///  构造IndustrydataClient 对象
                ///</summary>
                public IndustrydataClient Build()
                {
                    if (industrydataClient.CredentialsProvider == null)
                    {
                        ...
                        if (industrydataClient.credentialsProvider == null)
                        {
                            throw new ArgumentNullException("IndustrydataClient build error: jdcloud credentials provider not set");
                        }
                    }
                    if (industrydataClient.HttpRequestConfig == null)
                    {
                        ...
                        if (industrydataClient.httpRequestConfig == null)
                        {
                        throw new ArgumentNullException("IndustrydataClient build error: http request config not set");
                        }
                    }
