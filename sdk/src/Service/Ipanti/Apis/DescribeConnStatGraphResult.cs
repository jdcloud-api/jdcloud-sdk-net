...
namespace  JDCloudSDK.Ipanti.Apis
{
    ...
    ///  新建与并发连接数统计报表        
        ...
        ///         /// 
    /// </summary>
    public class DescribeConnStatGraphResult : JdcloudResult
    {
        ///<summary>
        /// 新建连接数
        ///</summary>
        public List<long?> NewConn{ get; set; }

        ///<summary>
        /// 并发活跃连接数
        ///</summary>
        public List<long?> ActiveConn{ get; set; }

        ///<summary>
        /// 并发非活跃连接数
        ///</summary>
        public List<long?> InactiveConn{ get; set; }
