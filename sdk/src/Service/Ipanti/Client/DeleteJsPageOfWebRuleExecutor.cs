...
namespace JDCloudSDK.Ipanti.Client
{
    ...
    /// </summary>
    public class DeleteJsPageOfWebRuleExecutor : JdcloudExecutor
    {
        /// <summary>
        ///  删除网站类规则允许插入 JS 指纹的页面。支持批量操作, 批量操作时 jsPageId 传多个, 以 &#39;,&#39; 分隔接口的Http 请求方法
        /// </summary>
        ...
        /// <summary>
        ///  删除网站类规则允许插入 JS 指纹的页面。支持批量操作, 批量操作时 jsPageId 传多个, 以 &#39;,&#39; 分隔接口的Http资源请求路径
        /// </summary>
