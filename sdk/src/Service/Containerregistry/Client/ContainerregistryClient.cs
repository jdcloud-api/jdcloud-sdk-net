...
using JDCloudSDK.Containerregistry.Apis;
...
namespace JDCloudSDK.Containerregistry.Client
{
    /// <summary>
    ///  容器镜像仓库
    ///  容器镜像仓库服务
    ///  Containerregistry Api 客户端
    ///</summary>
    public class ContainerregistryClient : JdcloudClient
    {
        ...
        /// </summary>
        /// <param name="credentialsProvider">认证信息</param>
        public ContainerregistryClient(CredentialsProvider credentialsProvider)
        {
            this.credentialsProvider = credentialsProvider;
        }
        ...
        private const string defaultEndpoint = "containerregistry.jdcloud-api.com";
        private const string serviceName = "containerregistry";
        ...
        public async Task<DescribeRegistriesResponse> DescribeRegistries(DescribeRegistriesRequest request) {
            ...
            /// <summary>
            ///  默认ContainerregistryClient 构造器 接口
            ///</summary>
            public interface Builder
            {
                ...
                /// <summary>
                ///  构造ContainerregistryClient 对象
                ///</summary>
                ContainerregistryClient Build();
            }

            /// <summary>
            ///  默认ContainerregistryClient 构造器
            ///</summary>
            public class DefaultBuilder : Builder
            {
                /// <summary>
                ///  ContainerregistryClient service client
                /// </summary>
                private  ContainerregistryClient containerregistryClient;

                /// <summary>
                ///  默认ContainerregistryClient 构造器构造对象
                ///</summary>
                ...
                public ContainerregistryClient Build()
                {
                    if (containerregistryClient.CredentialsProvider == null)
                    {
                        ...
                        if (containerregistryClient.credentialsProvider == null)
                        {
                            throw new ArgumentNullException("ContainerregistryClient build error: jdcloud credentials provider not set");
                        }
                    }
                    if (containerregistryClient.HttpRequestConfig == null)
                    {
                        ...
                        if (containerregistryClient.httpRequestConfig == null)
                        {
                        throw new ArgumentNullException("ContainerregistryClient build error: http request config not set");
                        }
                    }
